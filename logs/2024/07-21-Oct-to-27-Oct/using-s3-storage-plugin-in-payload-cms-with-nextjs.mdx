---
title: Using S3 Storage Plugin in Payload CMS with Next.js
description: Learn how to integrate the S3 Storage Plugin in Payload CMS with Next.js. Follow this guide to configure S3, manage bucket policies, and handle file uploads seamlessly.
date: 2024-10-25
---
