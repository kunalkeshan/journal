...
const social: SocialLink[] = [
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/kunalkeshan',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/kunalkeshan',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
    ...
    <div className="bg-white">
      <main className="mx-auto w-full max-w-7xl px-6 pb-16 pt-10 sm:pb-24 lg:px-8">
        <div className="mx-auto mt-20 max-w-2xl text-center sm:mt-24">
          <p className="text-base/8 font-semibold text-slate-600">404</p>
        ...
        <div className="mx-auto mt-16 flow-root max-w-lg sm:mt-20">
          ...
          >
            {latestLogs.map((link, linkIdx) => (
              <li
                key={`latest-log-not-found-page-${linkIdx}`}
                className="relative flex gap-x-6 py-6"
              >
                <div className="flex-auto">
                  <h3 className="text-sm/6 font-semibold text-gray-900">
                    <Link href={`/logs/${link.slug}`} prefetch={false}>
          ...
          <div className="mt-10 flex justify-center">
            <Link
              href="/"
              prefetch={false}
              className="text-sm/6 font-semibold text-slate-600"
            >
      ...
      <footer className="border-t border-gray-100 py-6 sm:py-10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-center gap-8 px-6 sm:flex-row lg:px-8">
          <p className="text-sm/7 text-gray-400">
            &copy; journal.kunalkeshan.dev. All rights reserved.
          </p>
